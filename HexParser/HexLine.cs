...
public class HexLine {
    public HexLine(string line) {
        ...
        //Type = (DataType)short.Parse(line[7..9], System.Globalization.NumberStyles.HexNumber);
    ...
    public byte[] DataBytes { 
        get => 
            Data.Chunk(2).Select(ch => byte.Parse(ch, System.Globalization.NumberStyles.HexNumber)).ToArray();
        }
